...
def draw_barplot(df_m) : 
    """ 
    This method used to create a bar plot. Arguments:
    ...
    fig, ax = plt.subplots()
    ax.bar(df_m["Country"], df_m["ValueAccurate"], width=0.5, color="limegreen")
...
# Read data file
data = pd.read_csv("C:\\Users\\kthat\\OneDrive\\data\\popuation-cleanfuels-technology2.csv")
...
df = df.rename(columns={"FactValueNumeric":"ValueAccurate", 
                        "FactValueNumericLow":"ValueLow", 
                        "FactValueNumericHigh":"ValueHigh"})
